...
#ifdef DPU_TARGET
/* I just noticed that all of this crap already existed in the source
 * tree, but noone cared to use this header. I'm adding this anyways, since
 * I've already changed all the calls
 */
...
{
#ifdef DPU_TARGET /* big endian, no swap */
	return hostshort;
#else	/* little endian (probably) */
...
static inline uint32_t ntohl(uint16_t netlong)
{
