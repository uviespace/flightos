...
\begin{versionhistory}
  ...
  \vhEntry{1.1}{31.08.2026}{AL}{adopt FlightOS name, add refernces to LEON3/4 targets, update requirements}
\end{versionhistory}
...
\emph{FlightOS}. FlightOS targets \gls{LEON3}-based platforms such as
\emph{GR712RC} and \emph{GR740}. It also has legacy support for the \gls{SSDP},
and to a lesser extent, its compatible predecessor, the \gls{MPPB} v2.x \cite{MPPB}.
...
FlightOS is a lightweight operating system for space-based astronomy applications
for European \gls{SPARC}-based processors.
...
concept. After the \gls{SSDP} project was abandoned, the
operating system was generalised to support the \gls{LEON3} family of European
processors for space. In addition, the project also provides software test
coverage, example applications and documentation that supports all aspects
of the software.


\section{Environmental considerations}

FlightOS currently primarily supports the \emph{GR712RC} and \emph{GR740}, but
legacy functionality to operate the \gls{SSDP} and \gls{MPPB} v2.x is available.
Ultimately, this does allow reuse of the operating system core
for \gls{LEON2} and \gls{LEON3} based platforms with minor adaptations.
For multi-core processors \gls{SMP} support is available. The operating system
can also make use of the SPARC SRMMU.

FlightOS is released under an open source license, so compatible development
tools should be available under such licenses as well. Note that it might still
be necessary to use a commercial product to target particular configurations or
proprietary hardware functionality.
...
FlightOS primarily targets the \emph{GR712RC} and \emph{GR740} processors,
which effectively limits the hardware support to the characteristics of this platform. \\
\noindent
...
FlightOS shall offer an Earliest Deadline First scheduler supporting priority
...
\goal{FUN-0019} {Semaphores and Mutexes}{%
FlightOS should provide semaphores and mutexes as part of its task functionality.
...
\requirement{FUN-0023} {Application Loading}{%
FlightOS shall be capable of parsing and executing applications in ELF format.
}{}%
...
This is the point where a project configuration can be initialised and the
application software can be loaded.%
}%
...
\goal{FUN-0025} {SSDP Device Drivers}{%
...
\requirement{FUN-0028} {GRSPW2 Device Drivers}{%
FlightOS shall provide support for the GRSPW2 IP core.
}{}%

\requirement{FUN-0029} {SPI controller infrastructure}{%
FlightOS shall provide infrastructure for SPI controller drivers.
}{}%

\requirement{FUN-0030} {GRSPI controller driver}{%
FlightOS shall provide a driver for the GRSPI IP core.
}{}%
...
\requirement{GEN-0101} {SSDP Target Platform}{%
FlightOS shall support on the \gls{SSDP}, in particular the \gls{LEON3-FT}
processor of the platform. It should also support the predecessor \gls{MPPB} v2.x.
}{}%

\requirement{GEN-0102} {GR712RC Target Platform}{%
FlightOS shall support on the \emph{GR712RC}.
}{}%

\requirement{GEN-0103} {GR740 Target Platform}{%
FlightOS shall support on the \emph{GR740}.
}{}%
...
In FlightOS, hardware is accessed in multiple layers of
