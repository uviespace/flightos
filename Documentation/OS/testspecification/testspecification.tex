...
\testbegin{Integrated System Test of \gls{Xentium} Processing Network}{%
...
\testrow{PRE}{ }{LeanOS source directory}{}%
...
\testrow{STP}{4}{Verify that the program image is uploaded to the \gls{MPPB} via%
		 \emph{grmon}}{}%
