...
\begin{versionhistory}
  ...
  \vhEntry{1.1}{31.08.2026}{AL}{adopt FlightOS name}
\end{versionhistory}
...
\noindent
FlightOS\cite{ssdpOS}\cite{flightosADD}\cite{flightosSRS} is an operating system
targeting \gls{LEON3}-based platforms such as \emph{GR712RC} and \emph{GR740},
but also has legacy support for drivers and data processing on the
