...
% REQ ID arg must be string, otherwise do the following to evaluate your macros:
% e.g.:
% \edef\temp{\Cat-\N/\Type\Ver}
% \expandafter\req\expandafter{\temp}{whatevertextlabel}>
	...
	\csvreader[myImportReqStyle]{#1}{}
	 {
		...
		\vspace{-.65\baselineskip}	% uuuaaahhh..why? :(
		\edef\temp{\Cat-\N}
		\cellcolor{uvie-blue!75}\color{white}\expandafter\req\expandafter{\temp}{\Cat-\N/\Type\Ver} &%
		\vspace{-.65\baselineskip}%
		\cellcolor{uvie-blue!50}\color{white}\textbf{Short Text} &%
		\vspace{-.65\baselineskip}%
		\cellcolor{uvie-blue!50}\color{white}\textbf{Software Requirement} \\%
		...
		\ifthenelse{\equal{\ReferenceId}{}} {}{%
			...
			\vspace{-1em}%
			\color{uvie-blue!75}\textbf{Requirement}&%
			\multicolumn{2}{|>{\arraybackslash}X}{\ReferenceId}%
		}%
		\vspace{1em}
